...
void setup() {
  ...
  uint8_t uiEspNowVersion= uiGetESPNOWVersion();                               // Supported ESP NOW version
  Serial.printf("ESP NOW Version     :V%d\n",uiEspNowVersion);

  const esp_app_desc_t *pAppDesc = esp_app_get_description();                  // Don't know what it means
